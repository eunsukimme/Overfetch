...
추가된 것
// 방어구 팩 생성 - 10분당 평균: 19.73
// 방어구 팩 생성 - 한 게임 최고기록: 14
// 생성한 방어구 팩: 41
  ...
  const aggregation = User.aggregate([
    ...
    },
    {
      $group: {
        ...
        "생성한 방어구 팩": {
          $avg: "$rankplay.record.토르비욘.영웅별.생성한 방어구 팩"
        },
        ...
        "게임당_생성한 방어구 팩": {
          $avg: {
            $divide: [
              "$rankplay.record.토르비욘.영웅별.생성한 방어구 팩",
              "$rankplay.record.토르비욘.게임.치른 게임"
            ]
          }
        },
    ...
    },
    {
      $addFields: {
        ...
        "게임당_생성한 방어구 팩.avg": "$게임당_생성한 방어구 팩",
        "게임당_생성한 방어구 팩.min": "$게임당_생성한 방어구 팩_최소",
        "게임당_생성한 방어구 팩.max": "$게임당_생성한 방어구 팩_최대"
      }
    },
    {
      $project: {
