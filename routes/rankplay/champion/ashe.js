    ...
    },
    {
      $group: {
        ...
        "게임당_다이너마이트로 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.애쉬.영웅별.다이너마이트로 처치",
              "$rankplay.record.애쉬.게임.치른 게임"
            ]
          }
        },
        "게임당_다이너마이트로 처치_최소": {
        ...
        "게임당_저격 치명타 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.애쉬.영웅별.저격 치명타 처치",
              "$rankplay.record.애쉬.게임.치른 게임"
            ]
          }
        },
        ...
        "게임당_충격 샷건으로 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.애쉬.영웅별.충격 샷건으로 처치",
              "$rankplay.record.애쉬.게임.치른 게임"
            ]
          }
        },
