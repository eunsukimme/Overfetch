  ...
  const aggregation = User.aggregate([
    ...
    },
    {
      $group: {
        ...
        "대지분쇄로 처치 - 10분당 평균": {
          $avg:
            "$rankplay.record.라인하르트.영웅별.대지분쇄로 처치 - 10분당 평균"
        },
        "대지분쇄로 처치 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.라인하르트.영웅별.대지분쇄로 처치 - 한 게임 최고기록"
        },
        "막은 피해": {
        ...
        "막은 피해 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.라인하르트.영웅별.막은 피해 - 한 게임 최고기록"
        },
        "돌진으로 처치": {
        ...
        "돌진으로 처치 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.라인하르트.영웅별.돌진으로 처치 - 한 게임 최고기록"
        },
        "화염 강타로 처치": {
        ...
        "화염 강타로 처치 - 10분당 평균": {
          $avg:
            "$rankplay.record.라인하르트.영웅별.화염 강타로 처치 - 10분당 평균"
        },
        "화염 강타로 처치 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.라인하르트.영웅별.화염 강타로 처치 - 한 게임 최고기록"
        },
        ...
        "로켓 해머 근접 공격 적중률_최소": {
          $min: {
            $avg:
              "$rankplay.record.라인하르트.영웅별.로켓 해머 근접 공격 적중률"
          }
        },
        "로켓 해머 근접 공격 적중률_최대": {
          $max: {
        ...
        "게임당_대지분쇄로 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.라인하르트.영웅별.대지분쇄로 처치",
              "$rankplay.record.라인하르트.게임.치른 게임"
            ]
          }
        },
        "게임당_대지분쇄로 처치_최소": {
        ...
        "게임당_막은 피해": {
          $avg: {
            $divide: [
              "$rankplay.record.라인하르트.영웅별.막은 피해",
              "$rankplay.record.라인하르트.게임.치른 게임"
            ]
          }
        },
        ...
        "게임당_돌진으로 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.라인하르트.영웅별.돌진으로 처치",
              "$rankplay.record.라인하르트.게임.치른 게임"
            ]
          }
        },
        ...
        "게임당_화염 강타로 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.라인하르트.영웅별.화염 강타로 처치",
              "$rankplay.record.라인하르트.게임.치른 게임"
            ]
          }
        },
