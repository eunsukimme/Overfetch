  ...
  const aggregation = User.aggregate([
    ...
    },
    {
      $group: {
        ...
        "감시 포탑으로 처치 - 10분당 평균": {
          $avg:
            "$rankplay.record.시메트라.영웅별.감시 포탑으로 처치 - 10분당 평균"
        },
        "감시 포탑으로 처치 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.시메트라.영웅별.감시 포탑으로 처치 - 한 게임 최고기록"
        },
        "막은 피해": {
        ...
        "순간이동한 플레이어 - 10분당 평균": {
          $avg:
            "$rankplay.record.시메트라.영웅별.순간이동한 플레이어 - 10분당 평균"
        },
        "순간이동한 플레이어 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.시메트라.영웅별.순간이동한 플레이어 - 한 게임 최고기록"
        },
        ...
        "게임당_감시 포탑으로 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.시메트라.영웅별.감시 포탑으로 처치",
              "$rankplay.record.시메트라.게임.치른 게임"
            ]
          }
        },
        "게임당_감시 포탑으로 처치_최소": {
        ...
        "게임당_막은 피해": {
          $avg: {
            $divide: [
              "$rankplay.record.시메트라.영웅별.막은 피해",
              "$rankplay.record.시메트라.게임.치른 게임"
            ]
          }
        },
        ...
        "게임당_순간이동한 플레이어": {
          $avg: {
            $divide: [
              "$rankplay.record.시메트라.영웅별.순간이동한 플레이어",
              "$rankplay.record.시메트라.게임.치른 게임"
            ]
          }
        },
