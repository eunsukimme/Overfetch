    ...
    },
    {
      $group: {
        ...
        "게임당_나노 강화제 도움": {
          $avg: {
            $divide: [
              "$rankplay.record.아나.영웅별.나노 강화제 도움",
              "$rankplay.record.아나.게임.치른 게임"
            ]
          }
        },
        "게임당_나노 강화제 도움_최소": {
        ...
        "게임당_나노 강화제 주입": {
          $avg: {
            $divide: [
              "$rankplay.record.아나.영웅별.나노 강화제 주입",
              "$rankplay.record.아나.게임.치른 게임"
            ]
          }
        },
        ...
        "게임당_생체 수류탄 처치": {
          $avg: {
            $divide: [
              "$rankplay.record.아나.영웅별.생체 수류탄 처치",
              "$rankplay.record.아나.게임.치른 게임"
            ]
          }
        },
