...
router.get('/', (req, res, next) => {
    ...
    const aggregation = User.aggregate([
        ...
        {
            $addFields: {
                "평균_게임당_나노 강화제 도움.avg": "$평균_게임당_나노 강화제 도움",
                "평균_게임당_나노 강화제 도움.min": "$평균_게임당_나노 강화제 도움_최소",
                "평균_게임당_나노 강화제 도움.max": "$평균_게임당_나노 강화제 도움_최대",

                "평균_게임당_나노 강화제 주입.avg": "$평균_게임당_나노 강화제 주입",
                "평균_게임당_나노 강화제 주입.min": "$평균_게임당_나노 강화제 주입_최소",
                "평균_게임당_나노 강화제 주입.max": "$평균_게임당_나노 강화제 주입_최대",

                "평균_게임당_생체 수류탄 처치.avg": "$평균_게임당_생체 수류탄 처치",
                "평균_게임당_생체 수류탄 처치.min": "$평균_게임당_생체 수류탄 처치_최소",
                "평균_게임당_생체 수류탄 처치.max": "$평균_게임당_생체 수류탄 처치_최대",

                "평균_게임당_자가 치유.avg": "$평균_게임당_자가 치유",
                "평균_게임당_자가 치유.min": "$평균_게임당_자가 치유_최소",
                "평균_게임당_자가 치유.max": "$평균_게임당_자가 치유_최대",

                "평균_게임당_재운 적.avg": "$평균_게임당_재운 적",
                "평균_게임당_재운 적.min": "$평균_게임당_재운 적_최소",
                "평균_게임당_재운 적.max": "$평균_게임당_재운 적_최대",
