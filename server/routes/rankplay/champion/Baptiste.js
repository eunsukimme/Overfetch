    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '평균_게임당_불사 장치로 사망 저지_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.바티스트.영웅별.불사 장치로 사망 저지', '$rankplay.record.바티스트.게임.치른 게임' ] }
                    }
                },
                '평균_게임당_불사 장치로 사망 저지_최대': {
                    $max: {
                        $avg: { $divide: ['$rankplay.record.바티스트.영웅별.불사 장치로 사망 저지', '$rankplay.record.바티스트.게임.치른 게임' ] }
                    }
                },
                ...
                '평균_게임당_증폭 매트릭스 도움_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.바티스트.영웅별.증폭 매트릭스 도움', '$rankplay.record.바티스트.게임.치른 게임' ] }
                    }
                },
                '평균_게임당_증폭 매트릭스 도움_최대': {
                    $max: {
                        $avg: { $divide: ['$rankplay.record.바티스트.영웅별.증폭 매트릭스 도움', '$rankplay.record.바티스트.게임.치른 게임' ] }
                    }
                },
                ...
                '평균_게임당_증폭 매트릭스 사용_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.바티스트.영웅별.증폭 매트릭스 사용', '$rankplay.record.바티스트.게임.치른 게임' ] }
                    }
                },
                '평균_게임당_증폭 매트릭스 사용_최대': {
                    $max: {
                        $avg: { $divide: ['$rankplay.record.바티스트.영웅별.증폭 매트릭스 사용', '$rankplay.record.바티스트.게임.치른 게임' ] }
                    }
                },
        ...
        {
            $addFields: {
                "평균_게임당_공격력 증폭.avg": "$평균_게임당_공격력 증폭",
                "평균_게임당_공격력 증폭.min": "$평균_게임당_공격력 증폭_최소",
                "평균_게임당_공격력 증폭.max": "$평균_게임당_공격력 증폭_최대",
                
                "평균_게임당_불사 장치로 사망 저지.avg": "$평균_게임당_불사 장치로 사망 저지",
                "평균_게임당_불사 장치로 사망 저지.min": "$평균_게임당_불사 장치로 사망 저지_최소",
                "평균_게임당_불사 장치로 사망 저지.max": "$평균_게임당_불사 장치로 사망 저지_최대",

                "평균_게임당_자가 치유.avg": "$평균_게임당_자가 치유",
                "평균_게임당_자가 치유.min": "$평균_게임당_자가 치유_최소",
                "평균_게임당_자가 치유.max": "$평균_게임당_자가 치유_최대",

                "평균_게임당_증폭 매트릭스 도움.avg": "$평균_게임당_증폭 매트릭스 도움",
                "평균_게임당_증폭 매트릭스 도움.min": "$평균_게임당_증폭 매트릭스 도움_최소",
                "평균_게임당_증폭 매트릭스 도움.max": "$평균_게임당_증폭 매트릭스 도움_최대",

                "평균_게임당_증폭 매트릭스 사용.avg": "$평균_게임당_증폭 매트릭스 사용",
                "평균_게임당_증폭 매트릭스 사용.min": "$평균_게임당_증폭 매트릭스 사용_최소",
                "평균_게임당_증폭 매트릭스 사용.max": "$평균_게임당_증폭 매트릭스 사용_최대",

                "평균_게임당_치유 증폭.avg": "$평균_게임당_치유 증폭",
                "평균_게임당_치유 증폭.min": "$평균_게임당_치유 증폭_최소",
                "평균_게임당_치유 증폭.max": "$평균_게임당_치유 증폭_최대",
            }
        },
        {
            $project: {
                "평균_게임당_공격력 증폭": 1,
                "평균_게임당_불사 장치로 사망 저지": 1,
                "평균_게임당_자가 치유": 1,
                "평균_게임당_증폭 매트릭스 도움": 1,
                "평균_게임당_증폭 매트릭스 사용": 1,
                "평균_게임당_치유 증폭": 1
