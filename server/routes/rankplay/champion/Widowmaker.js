    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '맹독 지뢰로 처치 - 10분당 평균': {
                    $avg: '$rankplay.record.위도우메이커.영웅별.맹독 지뢰로 처치 - 10분당 평균'
                },
                '맹독 지뢰로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.위도우메이커.영웅별.맹독 지뢰로 처치 - 한 게임 최고기록'
                },
                '저격 치명타': {
                ...
                '저격 치명타 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.위도우메이커.영웅별.저격 치명타 - 한 게임 최고기록'
                },
                '저격 치명타 처치': {
                    $avg: '$rankplay.record.위도우메이커.영웅별.저격 치명타 처치'
                },
                '저격 치명타 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.위도우메이커.영웅별.저격 치명타 처치 - 한 게임 최고기록'
                },
                ...
                '게임당_맹독 지뢰로 처치': {
                    $avg: { $divide: ['$rankplay.record.위도우메이커.영웅별.맹독 지뢰로 처치', '$rankplay.record.위도우메이커.게임.치른 게임' ] }
                },
                '게임당_맹독 지뢰로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.위도우메이커.영웅별.맹독 지뢰로 처치', '$rankplay.record.위도우메이커.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_맹독 지뢰로 처치_최대': {
                ...
                '게임당_저격 치명타': {
                    $avg: { $divide: ['$rankplay.record.위도우메이커.영웅별.저격 치명타', '$rankplay.record.위도우메이커.게임.치른 게임' ] }
                },
                '게임당_저격 치명타_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.위도우메이커.영웅별.저격 치명타', '$rankplay.record.위도우메이커.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_저격 치명타_최대': {
                ...
                '게임당_저격 치명타 처치': {
                    $avg: { $divide: ['$rankplay.record.위도우메이커.영웅별.저격 치명타 처치', '$rankplay.record.위도우메이커.게임.치른 게임' ] }
                },
                '게임당_저격 치명타 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.위도우메이커.영웅별.저격 치명타 처치', '$rankplay.record.위도우메이커.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_저격 치명타 처치_최대':{
                ...
                '게임당_자가 치유': {
                    $avg: { $divide: ['$rankplay.record.위도우메이커.영웅별.자가 치유', '$rankplay.record.위도우메이커.게임.치른 게임' ] }
                },
                '게임당_자가 치유_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.위도우메이커.영웅별.자가 치유', '$rankplay.record.위도우메이커.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_자가 치유_최대':{
