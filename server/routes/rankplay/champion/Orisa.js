  ...
  const aggregation = User.aggregate([
    ...
    },
    {
      $group: {
        ...
        "초강력 증폭기 도움 - 10분당 평균": {
          $avg:
            "$rankplay.record.오리사.영웅별.초강력 증폭기 도움 - 10분당 평균"
        },
        "초강력 증폭기 도움 - 한 게임 최고기록": {
          $avg:
            "$rankplay.record.오리사.영웅별.초강력 증폭기 도움 - 한 게임 최고기록"
        },
        ...
        "게임당_공격력 증폭": {
          $avg: {
            $divide: [
              "$rankplay.record.오리사.영웅별.공격력 증폭",
              "$rankplay.record.오리사.게임.치른 게임"
            ]
          }
        },
        "게임당_공격력 증폭_최소": {
        ...
        "게임당_초강력 증폭기 도움": {
          $avg: {
            $divide: [
              "$rankplay.record.오리사.영웅별.초강력 증폭기 도움",
              "$rankplay.record.오리사.게임.치른 게임"
            ]
          }
        },
