    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '보조 발사 적중률': {
                    $avg: '$rankplay.record.솜브라.영웅별.보조 발사 적중률'
                },
                '보조 발사 적중률_최소': {
                    $min: {
                        $avg: '$rankplay.record.솜브라.영웅별.보조 발사 적중률'
                ...
                '게임당_EMP 맞힌 적': {
                    $avg: { $divide: ['$rankplay.record.솜브라.영웅별.EMP 맞힌 적', '$rankplay.record.솜브라.게임.치른 게임' ] }
                },
                '게임당_EMP 맞힌 적_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.솜브라.영웅별.EMP 맞힌 적', '$rankplay.record.솜브라.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_EMP 맞힌 적_최대': {
                ...
                '게임당_해킹한 적': {
                    $avg: { $divide: ['$rankplay.record.솜브라.영웅별.해킹한 적', '$rankplay.record.솜브라.게임.치른 게임' ] }
                },
                '게임당_해킹한 적_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.솜브라.영웅별.해킹한 적', '$rankplay.record.솜브라.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_해킹한 적_최대': {
