    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '생명력 회복 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.트레이서.영웅별.생명력 회복 - 한 게임 최고기록'
                },
                '펄스 폭탄 부착': {
                ...
                '펄스 폭탄 부착 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.트레이서.영웅별.펄스 폭탄 부착 - 한 게임 최고기록'
                },
                '펄스 폭탄으로 처치': {
                    $avg: '$rankplay.record.트레이서.영웅별.펄스 폭탄으로 처치'
                },
                '펄스 폭탄으로 처치 - 10분당 평균': {
                    $avg: '$rankplay.record.트레이서.영웅별.펄스 폭탄으로 처치 - 10분당 평균'
                },
                '펄스 폭탄으로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.트레이서.영웅별.펄스 폭탄으로 처치 - 한 게임 최고기록'
                },
                '자가 치유': {
                ...
                '게임당_생명력 회복': {
                    $avg: { $divide: ['$rankplay.record.트레이서.영웅별.생명력 회복', '$rankplay.record.트레이서.게임.치른 게임' ] }
                },
                '게임당_생명력 회복_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.트레이서.영웅별.생명력 회복', '$rankplay.record.트레이서.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_생명력 회복_최대': {
                ...
                '게임당_펄스 폭탄 부착': {
                    $avg: { $divide: ['$rankplay.record.트레이서.영웅별.펄스 폭탄 부착', '$rankplay.record.트레이서.게임.치른 게임' ] }
                },
                '게임당_펄스 폭탄 부착_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.트레이서.영웅별.펄스 폭탄 부착', '$rankplay.record.트레이서.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_펄스 폭탄 부착_최대': {
                ...
                '게임당_펄스 폭탄으로 처치': {
                    $avg: { $divide: ['$rankplay.record.트레이서.영웅별.펄스 폭탄으로 처치', '$rankplay.record.트레이서.게임.치른 게임' ] }
                },
                '게임당_펄스 폭탄으로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.트레이서.영웅별.펄스 폭탄으로 처치', '$rankplay.record.트레이서.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_펄스 폭탄으로 처치_최대':{
                ...
                '게임당_자가 치유': {
                    $avg: { $divide: ['$rankplay.record.트레이서.영웅별.자가 치유', '$rankplay.record.트레이서.게임.치른 게임' ] }
                },
                '게임당_자가 치유_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.트레이서.영웅별.자가 치유', '$rankplay.record.트레이서.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_자가 치유_최대':{
