    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '평균_게임당_다이너마이트로 처치_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.애쉬.영웅별.다이너마이트로 처치', '$rankplay.record.애쉬.게임.치른 게임' ] }
                    }
                },
                '평균_게임당_다이너마이트로 처치_최대': {
                    $max: {
                        $avg: { $divide: ['$rankplay.record.애쉬.영웅별.다이너마이트로 처치', '$rankplay.record.애쉬.게임.치른 게임' ] }
                    }
                },
                ...
                '평균_게임당_충격 샷건으로 처치_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.애쉬.영웅별.충격 샷건으로 처치', '$rankplay.record.애쉬.게임.치른 게임' ] }
                    }
                },
                '평균_게임당_충격 샷건으로 처치_최대': {
                    $max: {
                        $avg: { $divide: ['$rankplay.record.애쉬.영웅별.충격 샷건으로 처치', '$rankplay.record.애쉬.게임.치른 게임' ] }
                    }
                },
        ...
        {
            $addFields: {
                "평균_게임당_다이너마이트로 처치.avg": "$평균_게임당_다이너마이트로 처치",
                "평균_게임당_다이너마이트로 처치.min": "$평균_게임당_다이너마이트로 처치_최소",
                "평균_게임당_다이너마이트로 처치.max": "$평균_게임당_다이너마이트로 처치_최대",

                "평균_게임당_밥으로 처치.avg": "$평균_게임당_밥으로 처치",
                "평균_게임당_밥으로 처치.min": "$평균_게임당_밥으로 처치_최소",
                "평균_게임당_밥으로 처치.max": "$평균_게임당_밥으로 처치_최대",

                "평균_게임당_저격 치명타.avg": "$평균_게임당_저격 치명타",
                "평균_게임당_저격 치명타.min": "$평균_게임당_저격 치명타_최소",
                "평균_게임당_저격 치명타.max": "$평균_게임당_저격 치명타_최대",

                "평균_게임당_저격 치명타 처치.avg": "$평균_게임당_저격 치명타 처치",
                "평균_게임당_저격 치명타 처치.min": "$평균_게임당_저격 치명타 처치_최소",
                "평균_게임당_저격 치명타 처치.max": "$평균_게임당_저격 치명타 처치_최대",

                "평균_게임당_충격 샷건으로 처치.avg": "$평균_게임당_충격 샷건으로 처치",
                "평균_게임당_충격 샷건으로 처치.min": "$평균_게임당_충격 샷건으로 처치_최소",
                "평균_게임당_충격 샷건으로 처치.max": "$평균_게임당_충격 샷건으로 처치_최대",
            }
        },
        {
            $project:{
