    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '갈고리로 끌어오기 - 10분당 평균': {
                    $avg: '$rankplay.record.로드호그.영웅별.갈고리로 끌어오기 - 10분당 평균'
                },
                '갈고리로 끌어오기 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.로드호그.영웅별.갈고리로 끌어오기 - 한 게임 최고기록'
                },
                '돼재앙으로 처치': {
                ...
                '돼재앙으로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.로드호그.영웅별.돼재앙으로 처치 - 한 게임 최고기록'
                },
                '자가 치유': {
                ...
                '보조 발사 적중률': {
                    $avg: '$rankplay.record.로드호그.영웅별.보조 발사 적중률'
                },
                '보조 발사 적중률_최소': {
                    $min: {
                        $avg: '$rankplay.record.로드호그.영웅별.보조 발사 적중률'
                ...
                '게임당_갈고리로 끌어오기': {
                    $avg: { $divide: ['$rankplay.record.로드호그.영웅별.갈고리로 끌어오기', '$rankplay.record.로드호그.게임.치른 게임' ] }
                },
                '게임당_갈고리로 끌어오기_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.로드호그.영웅별.갈고리로 끌어오기', '$rankplay.record.로드호그.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_갈고리로 끌어오기_최대': {
                ...
                '게임당_돼재앙으로 처치': {
                    $avg: { $divide: ['$rankplay.record.로드호그.영웅별.돼재앙으로 처치', '$rankplay.record.로드호그.게임.치른 게임' ] }
                },
                '게임당_돼재앙으로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.로드호그.영웅별.돼재앙으로 처치', '$rankplay.record.로드호그.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_돼재앙으로 처치_최대': {
                ...
                '게임당_자가 치유': {
                    $avg: { $divide: ['$rankplay.record.로드호그.영웅별.자가 치유', '$rankplay.record.로드호그.게임.치른 게임' ] }
                },
                '게임당_자가 치유_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.로드호그.영웅별.자가 치유', '$rankplay.record.로드호그.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_자가 치유_최대':{
