    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '고에너지로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.자리야.영웅별.고에너지로 처치 - 한 게임 최고기록'
                },
                '막은 피해': {
                ...
                '중력자탄으로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.자리야.영웅별.중력자탄으로 처치 - 한 게임 최고기록'
                },
                ...
                '게임당_고에너지로 처치': {
                    $avg: { $divide: ['$rankplay.record.자리야.영웅별.고에너지로 처치', '$rankplay.record.자리야.게임.치른 게임' ] }
                },
                '게임당_고에너지로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.자리야.영웅별.고에너지로 처치', '$rankplay.record.자리야.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_고에너지로 처치_최대': {
                ...
                '게임당_막은 피해': {
                    $avg: { $divide: ['$rankplay.record.자리야.영웅별.막은 피해', '$rankplay.record.자리야.게임.치른 게임' ] }
                },
                '게임당_막은 피해_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.자리야.영웅별.막은 피해', '$rankplay.record.자리야.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_막은 피해_최대': {
                ...
                '게임당_방벽 씌우기': {
                    $avg: { $divide: ['$rankplay.record.자리야.영웅별.방벽 씌우기', '$rankplay.record.자리야.게임.치른 게임' ] }
                },
                '게임당_방벽 씌우기_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.자리야.영웅별.방벽 씌우기', '$rankplay.record.자리야.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_방벽 씌우기_최대':{
                ...
                '게임당_중력자탄으로 처치': {
                    $avg: { $divide: ['$rankplay.record.자리야.영웅별.중력자탄으로 처치', '$rankplay.record.자리야.게임.치른 게임' ] }
                },
                '게임당_중력자탄으로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.자리야.영웅별.중력자탄으로 처치', '$rankplay.record.자리야.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_중력자탄으로 처치_최대':{
