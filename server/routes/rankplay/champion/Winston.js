    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '근접 공격으로 처치 - 10분당 평균': {
                    $avg: '$rankplay.record.윈스턴.영웅별.근접 공격으로 처치 - 10분당 평균'
                },
                '근접 공격으로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.윈스턴.영웅별.근접 공격으로 처치 - 한 게임 최고기록'
                },
                '막은 피해': {
                ...
                '밀쳐낸 플레이어 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.윈스턴.영웅별.밀쳐낸 플레이어 - 한 게임 최고기록'
                },
                '원시의 분노로 처치': {
                    $avg: '$rankplay.record.윈스턴.영웅별.원시의 분노로 처치'
                },
                '원시의 분노로 처치 - 10분당 평균': {
                    $avg: '$rankplay.record.윈스턴.영웅별.원시의 분노로 처치 - 10분당 평균'
                },
                '원시의 분노로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.윈스턴.영웅별.원시의 분노로 처치 - 한 게임 최고기록'
                },
                '점프 팩으로 처치': {
                ...
                '점프 팩으로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.윈스턴.영웅별.점프 팩으로 처치 - 한 게임 최고기록'
                },
                '무기로 처치': {
                    $avg: '$rankplay.record.윈스턴.영웅별.점프 팩으로 처치'
                },
                ...
                '게임당_근접 공격으로 처치': {
                    $avg: { $divide: ['$rankplay.record.윈스턴.영웅별.근접 공격으로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ] }
                },
                '게임당_근접 공격으로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.윈스턴.영웅별.근접 공격으로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_근접 공격으로 처치_최대': {
                ...
                '게임당_막은 피해': {
                    $avg: { $divide: ['$rankplay.record.윈스턴.영웅별.막은 피해', '$rankplay.record.윈스턴.게임.치른 게임' ] }
                },
                '게임당_막은 피해_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.윈스턴.영웅별.막은 피해', '$rankplay.record.윈스턴.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_막은 피해_최대': {
                ...
                '게임당_밀쳐낸 플레이어': {
                    $avg: { $divide: ['$rankplay.record.윈스턴.영웅별.밀쳐낸 플레이어', '$rankplay.record.윈스턴.게임.치른 게임' ] }
                },
                '게임당_밀쳐낸 플레이어_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.윈스턴.영웅별.밀쳐낸 플레이어', '$rankplay.record.윈스턴.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_밀쳐낸 플레이어_최대':{
                ...
                '게임당_원시의 분노로 처치': {
                    $avg: { $divide: ['$rankplay.record.윈스턴.영웅별.원시의 분노로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ] }
                },
                '게임당_원시의 분노로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.윈스턴.영웅별.원시의 분노로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_원시의 분노로 처치_최대':{
                ...
                '게임당_점프 팩으로 처치': {
                    $avg: { $divide: ['$rankplay.record.윈스턴.영웅별.점프 팩으로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ] }
                },
                '게임당_점프 팩으로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.윈스턴.영웅별.점프 팩으로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_점프 팩으로 처치_최대':{
                ...
                '게임당_무기로 처치': {
                    $avg: { $divide: ['$rankplay.record.윈스턴.영웅별.무기로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ] }
                },
                '게임당_무기로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.윈스턴.영웅별.무기로 처치', '$rankplay.record.윈스턴.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_무기로 처치_최대':{
        ...
        },
        {
            $addFields: {
                ...
                "원시의 분노 근접 공격 적중률.min": "$원시의 분노 근접 공격 적중률_최소",
