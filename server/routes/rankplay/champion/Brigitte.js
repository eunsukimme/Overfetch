    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '평균_게임당_막은 피해': {
                    $avg: { $divide: ['$rankplay.record.브리기테.영웅별.막은 피해', '$rankplay.record.브리기테.게임.치른 게임' ] }
                },
                '평균_게임당_막은 피해_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.브리기테.영웅별.막은 피해', '$rankplay.record.브리기테.게임.치른 게임' ] }
                ...
                '평균_게임당_방어력 제공': {
                    $avg: { $divide: ['$rankplay.record.브리기테.영웅별.방어력 제공', '$rankplay.record.브리기테.게임.치른 게임' ] }
                },
                '평균_게임당_방어력 제공_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.브리기테.영웅별.방어력 제공', '$rankplay.record.브리기테.게임.치른 게임' ] }    
                ...
                '평균_게임당_자가 치유': {
                    $avg: { $divide: ['$rankplay.record.브리기테.영웅별.자가 치유', '$rankplay.record.브리기테.게임.치른 게임' ] }
                },
                '평균_게임당_자가 치유_최소': {
                    $min: {
                        $avg: { $divide: ['$rankplay.record.브리기테.영웅별.자가 치유', '$rankplay.record.브리기테.게임.치른 게임' ] }
        ...
        },
        {
            $addFields:{
                ...
                "평균_게임당_방어력 제공.avg": "$평균_게임당_방어력 제공",
                "평균_게임당_방어력 제공.min": "$평균_게임당_방어력 제공_최소",
                "평균_게임당_방어력 제공.max": "$평균_게임당_방어력 제공_최대",
