...
router.get('/', (req, res, next) => {
    ...
    const aggregation = User.aggregate([
        ...
        {
            $addFields: {
                "평균_게임당_경계 모드로 처치.avg": "$평균_게임당_경계 모드로 처치",
                "평균_게임당_경계 모드로 처치.min": "$평균_게임당_경계 모드로 처치_최소",
                "평균_게임당_경계 모드로 처치.max": "$평균_게임당_경계 모드로 처치_최대",

                "평균_게임당_수색 모드로 처치.avg": "$평균_게임당_수색 모드로 처치",
                "평균_게임당_수색 모드로 처치.min": "$평균_게임당_수색 모드로 처치_최소",
                "평균_게임당_수색 모드로 처치.max": "$평균_게임당_수색 모드로 처치_최대",

                "평균_게임당_자가 치유.avg": "$평균_게임당_자가 치유",
                "평균_게임당_자가 치유.min": "$평균_게임당_자가 치유_최소",
                "평균_게임당_자가 치유.max": "$평균_게임당_자가 치유_최대",

                "평균_게임당_전차 모드로 처치.avg": "$평균_게임당_전차 모드로 처치",
                "평균_게임당_전차 모드로 처치.min": "$평균_게임당_전차 모드로 처치_최소",
                "평균_게임당_전차 모드로 처치.max": "$평균_게임당_전차 모드로 처치_최대",
            }
        },
        {
            $project: {
