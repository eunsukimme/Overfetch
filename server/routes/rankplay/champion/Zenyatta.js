    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '보조 발사 적중률': {
                    $avg: '$rankplay.record.젠야타.영웅별.보조 발사 적중률'
                },
                '보조 발사 적중률_최소': {
                    $min: {
                        $avg: '$rankplay.record.젠야타.영웅별.보조 발사 적중률'
                ...
                '게임당_초월로 치유': {
                    $avg: { $divide: ['$rankplay.record.젠야타.영웅별.초월로 치유', '$rankplay.record.젠야타.게임.치른 게임' ] }
                },
                '게임당_초월로 치유_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.젠야타.영웅별.초월로 치유', '$rankplay.record.젠야타.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_초월로 치유_최대': {
                ...
                '게임당_자가 치유': {
                    $avg: { $divide: ['$rankplay.record.젠야타.영웅별.자가 치유', '$rankplay.record.젠야타.게임.치른 게임' ] }
                },
                '게임당_자가 치유_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.젠야타.영웅별.자가 치유', '$rankplay.record.젠야타.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_자가 치유_최대':{
