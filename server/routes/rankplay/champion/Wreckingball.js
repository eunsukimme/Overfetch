    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '밀쳐낸 플레이어 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.레킹볼.영웅별.밀쳐낸 플레이어 - 한 게임 최고기록'
                },
                ...
                '게임당_밀쳐낸 플레이어': {
                    $avg: { $divide: ['$rankplay.record.레킹볼.영웅별.밀쳐낸 플레이어', '$rankplay.record.레킹볼.게임.치른 게임' ] }
                },
                '게임당_밀쳐낸 플레이어_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.레킹볼.영웅별.밀쳐낸 플레이어', '$rankplay.record.레킹볼.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_밀쳐낸 플레이어_최대': {
