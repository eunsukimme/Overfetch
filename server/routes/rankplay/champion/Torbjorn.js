    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '초고열 용광로로 처치 - 10분당 평균': {
                    $avg: '$rankplay.record.토르비욘.영웅별.초고열 용광로로 처치 - 10분당 평균'
                },
                '초고열 용광로로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.토르비욘.영웅별.초고열 용광로로 처치 - 한 게임 최고기록'
                },
                '토르비욘이 직접 처치': {
                    $avg: '$rankplay.record.토르비욘.영웅별.토르비욘이 직접 처치'
                },
                '토르비욘이 직접 처치 - 10분당 평균': {
                    $avg: '$rankplay.record.토르비욘.영웅별.토르비욘이 직접 처치 - 10분당 평균'
                },
                '토르비욘이 직접 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.토르비욘.영웅별.토르비욘이 직접 처치 - 한 게임 최고기록'
                },
                '포탑으로 처치': {
                ...
                '포탑으로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.토르비욘.영웅별.포탑으로 처치 - 한 게임 최고기록'
                },
                '망치로 처치': {
                    $avg: '$rankplay.record.토르비욘.영웅별.망치로 처치'
                },
                '망치로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.토르비욘.영웅별.망치로 처치 - 한 게임 최고기록'
                },
                '과부하로 처치': {
                    $avg: '$rankplay.record.토르비욘.영웅별.과부하로 처치'
                },
                '과부하로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.토르비욘.영웅별.과부하로 처치 - 한 게임 최고기록'
                },
                ...
                '게임당_초고열 용광로로 처치': {
                    $avg: { $divide: ['$rankplay.record.토르비욘.영웅별.초고열 용광로로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ] }
                },
                '게임당_초고열 용광로로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.토르비욘.영웅별.초고열 용광로로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_초고열 용광로로 처치_최대': {
                ...
                '게임당_토르비욘이 직접 처치': {
                    $avg: { $divide: ['$rankplay.record.토르비욘.영웅별.토르비욘이 직접 처치', '$rankplay.record.토르비욘.게임.치른 게임' ] }
                },
                '게임당_토르비욘이 직접 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.토르비욘.영웅별.토르비욘이 직접 처치', '$rankplay.record.토르비욘.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_토르비욘이 직접 처치_최대': {
                ...
                '게임당_포탑으로 처치': {
                    $avg: { $divide: ['$rankplay.record.토르비욘.영웅별.포탑으로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ] }
                },
                '게임당_포탑으로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.토르비욘.영웅별.포탑으로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_포탑으로 처치_최대':{
                ...
                '게임당_망치로 처치': {
                    $avg: { $divide: ['$rankplay.record.토르비욘.영웅별.망치로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ] }
                },
                '게임당_망치로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.토르비욘.영웅별.망치로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_망치로 처치_최대':{
                ...
                '게임당_과부하로 처치': {
                    $avg: { $divide: ['$rankplay.record.토르비욘.영웅별.과부하로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ] }
                },
                '게임당_과부하로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.토르비욘.영웅별.과부하로 처치', '$rankplay.record.토르비욘.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_과부하로 처치_최대':{
