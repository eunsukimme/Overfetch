...
router.get('/', (req, res, next) => {
    ...
    console.log(`mercy champion analyzing... rank: ${rank}`);
    let min, max;
    {
        if(rank < 1500){
            min = 500;
    ...
    const aggregation = User.aggregate([
        ...
        },
        {
            $group:
            {
                ...
                '부활한 플레이어 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.메르시.영웅별.부활한 플레이어 - 한 게임 최고기록'
                },
                '블라스터로 처치': {
                ...
                '블라스터로 처치 - 한 게임 최고기록': {
                    $avg: '$rankplay.record.메르시.영웅별.블라스터로 처치 - 한 게임 최고기록'
                },
                '자가 치유': {
                ...
                '보조 발사 적중률': {
                    $avg: '$rankplay.record.메르시.영웅별.보조 발사 적중률'
                },
                '보조 발사 적중률_최소': {
                    $min: {
                        $avg: '$rankplay.record.메르시.영웅별.보조 발사 적중률'
                ...
                '게임당_공격력 증폭': {
                    $avg: { $divide: ['$rankplay.record.메르시.영웅별.공격력 증폭', '$rankplay.record.메르시.게임.치른 게임' ] }
                },
                '게임당_공격력 증폭_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.메르시.영웅별.공격력 증폭', '$rankplay.record.메르시.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_공격력 증폭_최대': {
                ...
                '게임당_부활한 플레이어': {
                    $avg: { $divide: ['$rankplay.record.메르시.영웅별.부활한 플레이어', '$rankplay.record.메르시.게임.치른 게임' ] }
                },
                '게임당_부활한 플레이어_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.메르시.영웅별.부활한 플레이어', '$rankplay.record.메르시.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_부활한 플레이어_최대': {
                ...
                '게임당_블라스터로 처치': {
                    $avg: { $divide: ['$rankplay.record.메르시.영웅별.블라스터로 처치', '$rankplay.record.메르시.게임.치른 게임' ] }
                },
                '게임당_블라스터로 처치_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.메르시.영웅별.블라스터로 처치', '$rankplay.record.메르시.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_블라스터로 처치_최대':{
                ...
                '게임당_자가 치유': {
                    $avg: { $divide: ['$rankplay.record.메르시.영웅별.자가 치유', '$rankplay.record.메르시.게임.치른 게임' ] }
                },
                '게임당_자가 치유_최소': {
                    $min: {
                        $avg: {
                            $divide: ['$rankplay.record.메르시.영웅별.자가 치유', '$rankplay.record.메르시.게임.치른 게임' ]
                        }
                    }
                },
                '게임당_자가 치유_최대':{
